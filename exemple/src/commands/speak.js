...
const speak = (message) => {
    ...
    if(message.content === "je lag") {
        var jelagEmbed = new Discord.RichEmbed() //je créais une variable dans laquelle je stocke le message encadré
        ...
        message.channel.send(jelagEmbed);//et là j'envoi mon message encadré sous forme de variable :-)
        //message.reply('');
        //message.reply();
     }
